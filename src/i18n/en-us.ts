export default {
  ...
  home: {
    card: {
      rate: 'ezUSD APR',
      fundCost: 'ezWETH Year Cost',
      rebalancePrice: 'ezWETH Rebalancing Price',
      leverage: 'ezWETH Leverage Ratio',
    },
    coin: 'Coin',
    price: 'Price',
    ...
    EZBT_totalSupply: 'ezWETH Total Supply',
    ...
    ezWETHTotalnetworth: 'ezWETH Total Networth',
