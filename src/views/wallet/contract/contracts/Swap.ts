...
export interface SwapInterface extends utils.Interface {
  functions: {
    ...
    "buyEther(uint256)": FunctionFragment;
    ...
    "saleEther(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "buyEther", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getRoleAdmin",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "saleEther", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "supportsInterface",
    data: BytesLike
  ): Result;
